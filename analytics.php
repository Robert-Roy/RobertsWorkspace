...
if(is_object($array)){
    ...
    mail('robertproy@live.com',  "Pageload Logged", 
    "$IP loaded $page at $time
...
Information about this ip:
    ...
    ");
        ...
        mail('robertproy@live.com',  "Analytics Failure", 
         "Analytics failed for some reason at $time for $IP CODE 2");
    }
    
}else{
mail('robertproy@live.com',  "Analytics Failure", 
    "Analytics failed for some reason at $time for $IP CODE 1");
}
?>
